...
API Genel Değişkenleri
    ...
    msgSpecialId: Raporlama için kullanılıyor. ID veya neden sms atıldığı bilgisi gönderebilir. (ÖRN: 1000000 Sisteme Giriş - Web Panel)
    isOtn : Birden çok numaraya tek bir mesaj içeriği göndermek için kullanılır. 
            Parametre değerleri: 
                True – Birden fazla numaraya mesaj gönderildiğinde “messageContent” parametresinde tek bir mesaj içeriği olduğunu kabul eder 
                       ve tüm numaralara bu içeriğin gönderilmesini sağlar.
                False – Birden fazla numaraya mesaj gönderildiğinde “messageContent” parametresinde her numara için ~ karakteri ile ayrılmış 
                        mesaj içerikleri olduğunu kabul eder
    headerCode : Servisin “GetSenderInfo” metodu ile veya müşteri hizmetlerinden temin edebileceğiniz numerik bir değerdir. 
                 Aynı alfanumeriği birden fazla sanal numara üzerinde veya operatörde kullanıyorsanız bu alfanumerikleri ayırt etmek için kullanılır. 
    ...
    responseType : Yanıtın hangi formatta döneceğini belirten parametredir.
                 ...
                 2 – Xml
                 3 – Json
    optionalParameters: Boş veya null bir değer girilebilir. Dökümanda “İSTEĞE BAĞLI PARAMETRE KULLANIMI” bölümünden detaylı bilgi edinilebilir.
